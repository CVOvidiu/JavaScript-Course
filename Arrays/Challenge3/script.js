...
const str = `Sarah's dog eats too `;
dogSarah.curFood < dogSarah.recommendedFood && console.log(str.concat(`little`));
dogSarah.curFood > dogSarah.recommendedFood && console.log(str.concat(`much`));
...
const okAmount = function(dog) {
    return dog.curFood > (dog.recommendedFood * 0.90) && dog.curFood < (dog.recommendedFood * 1.1)
}
...
// #8
const dogsCopy = [...dogs];
console.log(dogsCopy.sort((cur, next) => cur.recommendedFood - next.recommendedFood));
console.log(dogs);